...
const CreateAccountStep2: React.FunctionComponent = () => {
  ...
  return (
    <OnboardingLayout active={2}>
      <h1 className="text-3xl text-slate-800 font-bold mb-6">{t('create_account.step2_title')}</h1>
        ...
        <div className="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8">
          <label className="flex-1 relative block cursor-pointer">
            ...
            <div className="h-full text-center bg-white px-4 py-6 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
              ...
              <div className="font-medium text-slate-800 mb-1">{t('create_account.cloud_database')}</div>
              <div className="text-sm">{t('create_account.cloud_database_details')}</div>
            </div>
          ...
          <label className="flex-1 relative block cursor-pointer">
            ...
            <div className="h-full text-center bg-white px-4 py-6 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
              ...
              <div className="font-medium text-slate-800 mb-1">{t('create_account.custom_database')}</div>
              <div className="text-sm">{t('create_account.custom_database_details')}</div>
            </div>
            <div className="absolute inset-0 border-2 border-transparent peer-checked:border-primary-400 rounded pointer-events-none" aria-hidden="true"></div>
          </label>
        </div>
        <div className="flex items-center justify-between">
          <Link className="text-sm underline hover:no-underline" to="../step1">&lt;- {t('create_account.back')}</Link>
