    ...
    params=[
        {
            ...
            "registration_session_pending_alias": "default_pending",
            "registration_session_done_alias": "default_done",
        ...
        },
        {
            ...
            "registration_session_pending_alias": "secondary_pending",
            "registration_session_done_alias": "secondary_done",
...
def tenant_params(request, test_data: TestData) -> TenantParams:
    ...
    return TenantParams(
        ...
        registration_session_pending=test_data["registration_sessions"][
            params["registration_session_pending_alias"]
        ],
        registration_session_done=test_data["registration_sessions"][
            params["registration_session_done_alias"]
        ],
