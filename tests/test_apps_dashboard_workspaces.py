...
class TestCreateWorkspace:
    async def test_unauthorized(self, test_client_dashboard: httpx.AsyncClient):
        response = await test_client_dashboard.get("/workspaces/create")

        dashboard_unauthorized_assertions(response)

    @pytest.mark.authenticated_admin(mode="session")
    async def test_redirect_to_step1(self, test_client_dashboard: httpx.AsyncClient):
        response = await test_client_dashboard.get("/workspaces/create")
...
class TestCreateWorkspaceStep1:
    async def test_unauthorized(self, test_client_dashboard: httpx.AsyncClient):
        response = await test_client_dashboard.get("/workspaces/create/step1")
...
class TestCreateWorkspaceStep2:
    async def test_unauthorized(self, test_client_dashboard: httpx.AsyncClient):
        response = await test_client_dashboard.get("/workspaces/create/step2")
...
class TestCreateWorkspaceStep3:
    async def test_unauthorized(self, test_client_dashboard: httpx.AsyncClient):
        response = await test_client_dashboard.get("/workspaces/create/step3")
...
class TestCreateWorkspaceStep4:
    async def test_unauthorized(self, test_client_dashboard: httpx.AsyncClient):
        response = await test_client_dashboard.get("/workspaces/create/step4")
