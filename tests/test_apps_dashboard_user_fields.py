...
class TestListUserFields:
    async def test_unauthorized(
        ...
        response = await test_client_dashboard.get("/user-fields/")
...
class TestGetUserField:
    ...
    async def test_not_existing(
        ...
        response = await test_client_dashboard.get(f"/user-fields/{not_existing_uuid}")
    ...
    async def test_valid(
        ...
        response = await test_client_dashboard.get(f"/user-fields/{user_field.id}")
...
class TestCreateUserField:
    async def test_unauthorized(
        ...
        response = await test_client_dashboard.post("/user-fields/create", data={})
...
class TestUpdateUserField:
    ...
    async def test_configuration_choices_display(
        ...
        response = await test_client_dashboard.get(f"/user-fields/{user_field.id}/edit")
